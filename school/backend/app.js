...
import { courseRegistration, getCourseRegistrations } from './routes/course.js';
...
route.post('/course/register', courseRegistration);
route.get('/course/registrations/:id/courses', getCourseRegistrations);
